...
const translations = {
  de: {
    ...
    hero: {
      headline: 'Sichern Sie Ihren industriellen Kern mit bew?hrter Expertise',
      subheadline: 'NIS2-konforme Compliance, IEC 62443 Gap-Analysen, Gesch?ftskontinuit?t f?r den deutschen Mittelstand. Bezahlbar. Schnell. Ingenieurgetrieben.',
    ...
    home: {
      why: {
        ...
        subtitle: 'Wir kombinieren tiefgreifendes OT-Verst?ndnis mit modernster Technologie und regulatorischer Expertise.'
      },
      values: {
        ot_specialization: 'Wir arbeiten dort, wo klassische IT-Security endet: in Produktionsnetzen, SCADA-Systemen und mit industriellen Protokollen. Unser Fokus liegt auf Hochverf?gbarkeit und Safety.',
        method_cta: 'Unsere Methodik',
        tech_cta: 'Technologie im Einsatz'
      },
      cta: {
        more_expertise: 'Mehr ?ber unsere Expertise'
      }
    },
    services: {
      title: 'Unsere Leistungen',
      subtitle: 'OT Security Services',
      description: 'Spezialisierte OT-Sicherheit f?r kritische Infrastrukturen und Industrieanlagen',
      ...
      otRisk: {
        ...
        description: 'Threat & Risk Assessment (TARA) f?r Operational Technology',
        price: '?20.000?35.000',
        duration: '4?6 Wochen',
    ...
    about: {
      hero: {
        headline: 'Die K?pfe hinter SecureKern',
        subheadline: 'Engineering-driven. Praxisnah. Ohne Berater-Blasen.'
      },
      p1: 'Nach 15 Jahren in der Automotive-Industrie habe ich mehr Produktionsstillst?nde, SCADA-Kompromittierungen und ?Warum-funktioniert-die-Firewall-nicht??-Momente erlebt, als mir lieb ist.',
      p2: '2024 habe ich SecureKern gegr?ndet, um mittelst?ndischen Produktionsbetrieben praxisnahe OT-Expertise zu liefern ? Hands-on, pragmatisch und bezahlbar.',
      quote: 'Wenn ein Berater noch nie einen PLC debuggt hat, sollte er keine OT-Security-Roadmap schreiben.',
      values: {
        praxis: 'Unsere Empfehlungen funktionieren in der Realit?t, nicht nur auf Papier. Wir kennen die Einschr?nkungen einer 24/7-Produktion.',
        ...
        mittelstand: 'Wir verstehen die Budgets und Ressourcen des Mittelstands. Unsere L?sungen sind skalierbar und kosteneffizient.',
        engineering: 'Wir denken wie Ingenieure, nicht wie Compliance-Berater. Das Ergebnis: technisch fundierte und wirtschaftlich sinnvolle L?sungen.'
      }
    },
    contact: {
      hero: {
        headline: 'Lassen Sie uns sprechen',
        subheadline: 'Buchen Sie ein kostenloses 30-min?tiges Beratungsgespr?ch.'
      },
      form: {
        title: 'Beratungsgespr?ch buchen',
        description: 'Beschreiben Sie kurz Ihre Herausforderung ? wir melden uns mit einer ersten Einsch?tzung.',
        name: 'Name *',
        company: 'Unternehmen *',
        email: 'E-Mail *',
        phone: 'Telefon',
        message: 'Ihre Nachricht',
        consent: 'Ich akzeptiere die Datenschutzerkl?rung *',
        submit: 'Anfrage senden'
      }
    },
    resources: {
      title: 'Kostenlose Ressourcen',
      subtitle: 'Whitepapers, Leitf?den, Tools',
    ...
    solutions: {
      title: 'Branchenspezifische L?sungen',
      ...
      intro: 'SecureKern bietet keine generischen L?sungen. Unsere Experten verstehen die spezifischen OT-Protokolle, Compliance-Anforderungen und Betriebsabl?ufe Ihrer Branche ? und liefern ma?geschneiderte Sicherheitskonzepte, die in der Praxis funktionieren.',      automotive: {
        title: 'Produktionssicherheit f?r die Automobilindustrie',
    ...
    blog: {
      ...
      post1: {
        title: 'NIS2-Readiness: Was Mittelst?ndler bis 2025 wissen m?ssen',
        excerpt: 'Die neue NIS2-Richtlinie bringt erhebliche Ver?nderungen f?r mittelst?ndische Unternehmen.'
      },
      post2: {
    ...
    pages: {
      ...
      'iso-22301': { title: 'ISO 22301 BCMS f?r OT-Umgebungen' },
      'risk-training': { title: 'Risikobewertung & Training' },
      manufacturing: { title: 'OT-Sicherheit f?r Manufacturing & Automotive', headline: 'Compliance-Druck? Wir liefern L?sungen.' },
      downloads: { title: 'Downloads & Whitepapers' },
      certifications: { title: 'Qualifikationen & Partnerschaften' },
      chemical: { title: 'OT-Sicherheit f?r Chemie & Pharma' },
      energy: { title: 'OT-Sicherheit f?r Energy & Utilities' },
      'ot_mdr': { title: 'OT-MDR & Incident Response', subtitle: 'Rund-um-die-Uhr-Schutz f?r Ihre kritische Infrastruktur.', cta: 'Jetzt MDR-Beratung anfragen', why_title: 'Warum ist OT-spezifisches MDR entscheidend?', why_text: 'Klassische IT-Security-L?sungen versagen in der OT. Industrielle Protokolle, Echtzeitanforderungen und die hohe Kritikalit?t von Produktionsprozessen erfordern spezialisiertes Monitoring und Analysten, die den Unterschied zwischen einer Prozessoptimierung und einem Cyberangriff kennen.' },
      'nis2': { title: 'NIS2 Readiness Sprint', overview: 'Wir haben einen intensiven, ergebnisorientierten "Sprint" entwickelt, der speziell darauf ausgelegt ist, Ihr Unternehmen schnell und effizient auf die Anforderungen der NIS2-Richtlinie vorzubereiten. Anstatt monatelanger Projekte liefern wir in kurzer Zeit klare Analysen und einen umsetzbaren Ma?nahmenkatalog.' },
      impressum: { title: 'Impressum' },
      datenschutz: { title: 'Datenschutzerkl?rung' },
      agb: { title: 'Allgemeine Gesch?ftsbedingungen' }
    },
    meta: {
      index: {
        title: 'SecureKern ? OT-Cybersicherheit f?r kritische Infrastrukturen | NIS2 & IEC 62443',
        description: 'Spezialisierte OT/ICS-Cybersicherheit f?r deutsche Industrieunternehmen. NIS2-Readiness, IEC 62443 Gap-Analysen, Netzwerksegmentierung. Kostenlosen Security-Check buchen.'
      },
      loesungen: {
        title: 'Branchenspezifische L?sungen | SecureKern GmbH',
        description: 'Branchenspezifische OT-Sicherheitsl?sungen f?r Manufacturing, Energy und Chemicals ? zugeschnitten auf Ihre Industrie.'
      }
    },
    footer: {
      copyright: '? 2026 SecureKern GmbH. Alle Rechte vorbehalten.',
      about: 'SecureKern ist Ihr Partner f?r OT-Security. Wir sch?tzen kritische Infrastrukturen mit ma?geschneiderten Sicherheitsl?sungen.',
      links: {
...
// === STATE MANAGEMENT ===
let currentLang = localStorage.getItem('securekern_lang') || CONFIG.lang.default;
...
function updateLangToggleUI(){
  ...
  if (label) {
    label.textContent = currentLang === 'de' ? 'DE' : 'EN';
  }
  if (langToggle) {
    langToggle.setAttribute('title', currentLang === 'de' ? 'Deutsch' : 'English');
  }
}
  ...
  forms.forEach(form => {
    form.addEventListener('submit', async (e) => {
      ...
      if (!data.email || !data.name || !data.message) {
        showNotification('Bitte f?llen Sie alle Pflichtfelder aus.', 'error');
        return;
      }
      
      if (!isValidEmail(data.email)) {
        showNotification('Bitte geben Sie eine g?ltige E-Mail-Adresse ein.', 'error');
        return;
      }
      ...
      try {
        ...
        showNotification('Vielen Dank! Wir melden uns in K?rze bei Ihnen.', 'success');
        form.reset();
      } catch (error) {
        showNotification('Ein Fehler ist aufgetreten. Bitte versuchen Sie es sp?ter erneut.', 'error');
      }
    });
  });
}
